...
import { CameraIcon, UsbIcon, SmartphoneIcon, ChevronLeftIcon, ChevronRightIcon } from './icons/UIIcons';
...
export const DeviceList: React.FC<DeviceListProps> = ({ cameras, selectedCamera, onSelectCamera, isPanelOpen, onTogglePanel }) => {
  return (
